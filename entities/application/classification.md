...
description: A supervised learning task that predicts discrete categorical labels for input instances.
subtypes_of:
...
A supervised learning task that predicts discrete categorical labels for input instances.
