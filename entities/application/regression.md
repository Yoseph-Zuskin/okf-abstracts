...
type: Class
title: Regression
description: A supervised learning task that predicts continuous numerical values from input features.
subtype_of:
...
A supervised learning task that predicts continuous numerical values from input features.
