...
description: Computing infrastructure hosted by a cloud service provider, delivering compute, storage, and networking resources over the internet.
subtypes_of:
...
Computing infrastructure hosted by a cloud service provider, delivering compute, storage, and networking resources over the internet.
