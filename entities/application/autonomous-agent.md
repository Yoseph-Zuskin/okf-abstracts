...
description: A software agent that pursues goals on behalf of a principal with limited or no step-by-step direction.
tags:
  - application
  - agent
  - autonomous
subtypes_of:
- { type: Software Agent, resource: /entities/core/software-agent.md }
