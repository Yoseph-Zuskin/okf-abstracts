...
description: A large business enterprise operating across multiple countries with substantial headcount or revenue.
tags:
  - application
  - business
  - corporation
subtype_of:
- { type: Business Enterprise, resource: /entities/domain/business-enterprise.md, version: v0.1.0 }
...
A large business enterprise operating across multiple countries with substantial headcount or revenue.
