...
description: A training program delivered over the internet, typically part of a certificate.
tags:
  - application
  - education
  - online
subtype_of:
- { type: Training Program, resource: /entities/domain/training-program.md, version: v0.1.0 }
...
A training program delivered over the internet, typically part of a certificate.
