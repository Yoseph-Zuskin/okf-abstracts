...
description: A machine learning paradigm where the model discovers hidden patterns or structures in unlabeled data.
subtype_of:
- { type: Learning Paradigm, resource: /entities/domain/learning-paradigm.md, version: v0.1.0 }
...
A machine learning paradigm where the model discovers hidden patterns or
