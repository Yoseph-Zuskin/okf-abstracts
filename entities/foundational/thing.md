...
type: Class
title: Thing
description: Universal root class. Every class and every instance is a Thing. Highest abstraction; a subtype of the OKF data specification itself.
tags:
  - foundational
  - root
  - universal
subtype_of:
- { type: Spec, resource: /entities/foundational/okf-spec.md, version: v0.1.0 }
...
Universal root class. Every class and every instance is a Thing. Highest abstraction; the lattice root with no parent class.
