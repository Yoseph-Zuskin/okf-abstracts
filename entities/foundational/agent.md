...
type: Class
title: Agent
description: 'A performer of action: a person, an organization, or software. Agents do things.'
tags:
  - foundational
  - performer
subtype_of:
...
A performer of action: a person, an organization, or software. Agents do things.
...
Instances of `Agent` MUST:

- state what actions the agent can perform and what goals it pursues.
