...
type: Class
title: Concept
description: A unit of knowledge or an abstract idea. Concepts describe, they do not act.
tags:
  - foundational
  - knowledge-unit
subtype_of:
...
A unit of knowledge or an abstract idea. Concepts describe, they do not act.
...
Instances of `Concept` MUST:

- define the abstraction so two readers identify the same instances.
