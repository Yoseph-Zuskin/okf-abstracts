...
type: Class
title: Relation
description: A structured connection between entities, e.g. 'is a subtype of', 'belongs to', 'follows'.
tags:
  - foundational
  - connection
subtypes_of:
...
A structured connection between entities, e.g. 'is a subtype of', 'belongs to', 'follows'.
