...
type: Class
title: Template
description: A reusable fillable structural pattern that guides creation of a specific artifact.
tags:
  - domain
  - template
  - pattern
subtypes_of:
- { type: Operational Artifact, resource: /entities/core/operational-artifact.md }
...
A reusable fillable structural pattern that guides creation of a specific artifact.
