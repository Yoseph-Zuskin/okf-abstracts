...
description: A meeting period of a legislature during which it conducts its business.
tags:
  - domain
  - government
  - session
subtype_of:
- { type: Event, resource: /entities/core/event.md, version: v0.1.0 }
...
A meeting period of a legislature during which it conducts its business.
