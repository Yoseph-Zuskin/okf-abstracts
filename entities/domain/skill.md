...
A reusable, self-contained capability that encapsulates a specific workflow, methodology, or expertise domain — composable with other skills to form complex agent behaviors.
