...
type: Class
title: Election
description: An event in which eligible voters select candidates for public office.
tags:
  - domain
  - election
  - event
...
An event in which eligible voters select candidates for public office.
