...
description: A structured connection between two or more countries in international affairs.
tags:
  - domain
  - international
  - relation
subtype_of:
- { type: Relation, resource: /entities/foundational/relation.md, version: v0.1.0 }
...
A structured connection between two or more countries in international affairs.
