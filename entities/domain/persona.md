...
type: Class
title: Persona
description: A fictional representation of a target user or customer segment used to guide product design and marketing decisions.
subtypes_of:
- { type: Person, resource: /entities/core/person.md }
...
A fictional representation of a target user or customer segment used to guide
