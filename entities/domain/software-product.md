...
description: A product delivered as software, running on servers or devices used by its customers or organization.
tags:
  - domain
  - product
  - software
subtypes_of:
- { type: Product, resource: /entities/domain/product.md }
...
A product delivered as software, running on servers or devices used by its customers or organization.
