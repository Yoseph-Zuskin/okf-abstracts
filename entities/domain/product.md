...
type: Class
title: Product
description: A created artifact offered for use, delivery or exchange, typically to customers or users.
tags:
  - domain
  - product
  - artifact
...
A created artifact offered for use, delivery or exchange, typically to customers or users.
