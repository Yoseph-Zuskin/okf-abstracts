...
description: A structured course of study with modules, lessons and assessment.
tags:
  - domain
  - training
  - program
subtype_of:
- { type: Instructional Artifact, resource: /entities/core/instructional-artifact.md, version: v0.1.0 }
...
A structured course of study with modules, lessons and assessment.
