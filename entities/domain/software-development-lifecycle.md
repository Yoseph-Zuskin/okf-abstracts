...
description: The end-to-end process for planning, creating, testing, deploying, and maintaining software applications.
subtypes_of:
- { type: Process, resource: /entities/core/process.md }
...
The end-to-end process for planning, creating, testing, deploying, and maintaining software applications.
