...
description: 'An artifact that guides action or operations: runbooks, playbooks, checklists, templates.'
tags:
  - core
  - artifact
  - action-guidance
...
An artifact that guides action or operations: runbooks, playbooks, checklists, templates.
