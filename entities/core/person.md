...
type: Class
title: Person
description: A human being as an agent.
tags:
  - core
  - person
  - human
subtype_of:
- { type: Agent, resource: /entities/foundational/agent.md, version: v0.1.0 }
...
Instances of `Person` MUST:

- identify a human individual (not a role, not a persona).
