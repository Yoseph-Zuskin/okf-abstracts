...
type: Class
title: Workflow
description: A repeatable sequence of activities with defined inputs, outputs and owners.
tags:
  - core
  - process
  - workflow
...
A repeatable sequence of activities with defined inputs, outputs and owners.
