---
type: Class
title: Communicative Artifact
description: An artifact intended to transfer a message from a sender to a receiver.
tags:
  - core
  - artifact
  - communication
...
An artifact intended to transfer a message from a sender to a receiver.
