...
* [Foundational (L0)](/entities/foundational/index.md) - 9 classes: very basic

  abstractions; the top of the lattice.
* [Core (L1)](/entities/core/index.md) - 12 classes: general domain-neutral

  concepts.
* [Domain (L2)](/entities/domain/index.md) - 33 classes: specialized entities

  and content genres.
* [Application (L3)](/entities/application/index.md) - 42 classes: specific
